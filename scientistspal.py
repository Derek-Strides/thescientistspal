...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  4 20:58:17 2022
...
root = Tk()
root.title("The Scientists Pal")
root.configure(background = 'Gray')
root.resizable(width=False, height=False)
root.geometry("900x568+450+90")
calc = Frame(root)
calc.grid()
...
lblDisplay = Label(calc, text = "The Scientist's Pal",
...
def iExit():
	iExit = tkinter.messagebox.askyesno("The Scientist's Pal",
										"Do you want to exit ?")
	if iExit>0:
		root.destroy()
		return
